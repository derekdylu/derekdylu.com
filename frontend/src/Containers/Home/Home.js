    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-0 w-full py-8">
        <div className="w-full h-full px-3 md:pl-12 lg:pl-18 xl:pl-24 md:text-xl md:leading-loose text-center md:text-left">
          I am a dedicated college student majoring in Information Management at <a href="https://www.ntu.edu.tw/" target="_blank" rel="noreferrer" className="underline hover:text-primary">National Taiwan University</a>.
      ...
      <div className="flex flex-col items-center gap-8 w-full py-12">
        <div className="flex flex-col md:flex-row items-center gap-4">
          <a href="/contact">
            <div className="bg-primary hover:bg-primary-light active:bg-primary-dark px-6 py-2 rounded-xl text-white font-bold" style={{ cursor: "pointer" }} >
              Contact Me
            </div>
          </a>
          <div className="border border-primary hover:bg-primary-light active:bg-primary-dark px-6 py-2 rounded-xl text-primary hover:text-white active:text-white font-bold" style={{ cursor: "pointer" }} >
            Download My CV
          </div>
        </div>
      </div>
